<img width="1459" height="81" alt="image" src="https://github.com/user-attachments/assets/c14a32f0-ae40-429d-8992-89a9a3f994ef" />---
permalink: /
title: ""
excerpt: "About me"
author_profile: true
...
* **数据挖掘与检索**: 大规模信息检索、推荐、广告系统。CTR/CVR 预估、uplift 建模、lookalike 人群扩展，工业级亿级用户系统实战。
...
* 依托国家科技创新2030“脑科学与类脑研究”重大项目“支持在线学习的类脑芯片架构”，开展类脑大模型及芯片架构方面的研究；
* 已发表7篇顶会&顶刊论文，在审论文12篇，多篇成稿待投 ；申请发明专利4项。
...
**Real2Sim 场景重建平台**
自研自动化后端处理流程，将商业扫描仪（Revopoint、Apple LiDAR）采集的 STL/OBJ 数据，转换为含语义标注与物理参数的仿真级 USD 格式，支持 Isaac Sim 等主流平台直接导入。目标每人每天处理 1–2 个场景。
目标客户：机器人公司（训练场景供给）、大模型厂商（具身数据）、行业场景方（地铁/工厂/仓储数字化）

**工业级智能推荐与广告系统**
主导推荐与广告方向核心算法研发，覆盖 CTR/CVR 预估、uplift 建模、lookalike 扩展、active learning，搭建完整线上 serving 与 AB 实验体系，直接支撑亿级用户规模业务。

**IoT智能感知算法系统**
负责 IoT 业务方向视觉算法研发，将学术成果转化为产品级方案，覆盖图像识别、目标检测、智能感知等场景，打通算法到工程上线的全链路。
