...
* **多模态大模型**：跨模态数据融合、语义理解与知识表示，基于Agent的多模态内容理解与生成，领域大模型微调与后训练等，发表TCSVT/TIST/MM/TIOT等顶会&顶刊多篇。
* **计算机视觉**: 复杂环境（低光照、雨雪、遮挡）下的图像识别、检测、跟踪与增强，发表CVPR/ECCV/AAAI/IJCAI/TIFS 等顶会&顶刊多篇。
